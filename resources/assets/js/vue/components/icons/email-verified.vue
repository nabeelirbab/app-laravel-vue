            ...
            <g id="mail_rotate_group">
                <g id="mail_rescale_group" transform="scale(0, 0)">
                    <g id="mail_pivot_group" transform="translate(-180, -144)">
                        ...
                        <circle id="verify_ring" transform="translate(280 208) rotate(-45)" stroke="#19AB4B"
                            stroke-dasharray="403 403" stroke-dashoffset="-403" stroke-width="8" cx="0" cy="0" r="64"
                            stroke-opacity="0.66" fill-opacity="0.0">
                            <animate id="verify_ring_appear" attributeName="stroke-dashoffset" from="-403" to="0"
                                begin="verify_check_appear.end" dur="0.45s" fill="freeze" repeatCount="1" calcMode="spline"
                                values="-403; 0;" keyTimes="0; 1" keySplines="0.0 0.0 0.2 1" />
                        </circle>

                        <!-- CHECKMARK -->
                        <polyline id="verify_check" stroke="#19AB4B" stroke-width="8" fill-opacity="0.0"
                            stroke-opacity="0.66" points="313.186279 184.83783 313.186279 184.83783 313.186279 184.83783">
                            <animate id="verify_check_appear" attributeName="points"
                                from="313.186279 184.83783 313.186279 184.83783 313.186279 184.83783"
                                to="313.186279 184.83783 313.186279 184.83783 313.186279 184.83783"
                                begin="mail_appear_scale.end + 0.4s" dur="0.45s" fill="freeze" repeatCount="1"
                                calcMode="spline" values="
                        313.186279 184.83783 313.186279 184.83783 313.186279 184.83783;
                        313.186279 184.83783 268.236389 230.302795 268.236389 230.302795;
                        313.186279 184.83783 268.236389 230.302795 248.819885 210.656921" keyTimes="0; 0.33; 1"
                                keySplines="
                        0.0 0.0 0.2 1;
                        0.4 0.0 0.2 1" />
                        </polyline>
