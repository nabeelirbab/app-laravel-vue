<template>
    <div class="player" ref="player" v-show="$store.state.player.status.set">
        <audio ref="audio" @loadedmetadata="loaded" @timeupdate="timeUpdate" @ended="ended">
        ...
        <div class="player" v-if="!expanded">
            ...
            <div class="progress" @click="progressClick" @mousedown="startProgressDrag" @mousemove="doProgressDrag"
        ...
        <div v-else class="expanded">
            ...
            <div class="controls-bottom">
                <div class="controls">
                    ...
                    <div class="right">
                        <span @click="toggleRepeat" class="controls-repeat"
                            :class="{ active: $store.state.player.repeat }">
                            <i class="fa fa-redo" data-fa-transform="shrink-3"></i>
                        </span>
                        <!-- <span @click="shuffle = !shuffle" class="controls-shuffle"
                            :class="{ active: $store.state.player.shuffle }">
