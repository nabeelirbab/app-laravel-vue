<template>
    <modal name="modal-to-artist-downgrade" width="500px" height="auto" scrollable adaptive>
        <div class="modal modal-downgrade">
            ...
            <div class="modal-content">
                ...
                <div v-else="downgradeConfirm">
                    ...
                    <p>
                        Are you sure you want to downgrade to an Artist account? your account will remain the same until your paid period expires, you will then automatically be downgraded, any current membership benefits will be lost
                    </p>
...
export default {
    ...
    methods: {
        downgradeConfirmAccount() {
            ...
            axios.post('/api/account/downgrade/pro', { user_id: this.app.user })
                .then(response => {
