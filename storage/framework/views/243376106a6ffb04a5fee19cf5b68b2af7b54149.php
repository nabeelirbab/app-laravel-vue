            ...
            <tr>
                ...
                <td>
                    ...
                    <?php if($trackPath !== null): ?>
                     <audio src="<?php echo e($trackPath); ?>" controls="controls" preload="none">
                ...
                <td <?php if($track->status === 'pending'): ?> { 
                    class="bg-danger text-white p-2" 
                } <?php elseif($track->status === 'frozen'): ?> {
                class="bg-primary text-white p-2" 
                }
                <?php endif; ?>><?php echo e($track->status); ?></td>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\phase\resources\views/admin/tracks/index.blade.php ENDPATH**/ ?>