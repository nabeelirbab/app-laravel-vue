...
## Hey <?php echo e($user->first_name); ?>, we have received your request to resume  to an <?php echo e(\Illuminate\Support\Str::title($user->roles->first()->name)); ?> account
...
<?php endif; ?>
<?php echo $__env->renderComponent(); ?>
<?php /**PATH C:\xampp\htdocs\phase\resources\views/emails/account/resumed.blade.php ENDPATH**/ ?>